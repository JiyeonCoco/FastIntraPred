...
class DataBatch(NetManager):
    ...
    def unpackDataset(self, file_list, each_data_num):
        ...
        with open(file_list, 'rb') as data:
            ...
            # Full mode -> 35 modes
            elif self.isfullmode == 1:
                each_mode = self.MODE_NUM[2]
